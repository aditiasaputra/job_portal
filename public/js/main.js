...
(function($) {
    ...
    $("#form-user").on("submit", function(e) {
        ...
        $('.cancel').on('click', function() {
            $(".print-error-msg").removeClass("d-block").addClass("d-none");
        ...
        $.ajax({
            url: actionForm,
            type: "POST",
            data: { name, username, email, role, password, password_confirmation },
            dataType: "json",
            ...
            error: function(res) {
                ...
                console.log(`Message: ${res.responseJSON.message}`);
                console.log(`Exception: ${res.responseJSON.exception}`);
            }
        });
    });
})(jQuery);
